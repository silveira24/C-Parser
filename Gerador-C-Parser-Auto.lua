...
local dir = lfs.currentdir() .. '/pegparser/test/C-Parser/yes/'
util.testYes(dir, 'c', p)

dir = lfs.currentdir() .. '/pegparser/test/C-Parser/yes2/'
util.testYes(dir, 'c', p)

dir = lfs.currentdir() .. '/pegparser/test/C-Parser/no/'
util.testNo(dir, 'c', p)

print("\nStrict")
dir = lfs.currentdir() .. '/pegparser/test/C-Parser/no-strict/'
util.testNo(dir, 'c', p)
